...
messaged, because the send path now expects a sealed value.
    ...
    python human_pilot/operations/migrate_participant_identity.py            # report only
    python human_pilot/operations/migrate_participant_identity.py --export contacts.json
    python human_pilot/operations/migrate_participant_identity.py --apply
