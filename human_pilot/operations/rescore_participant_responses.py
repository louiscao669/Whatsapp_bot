...
Usage (from repo root):
  python human_pilot/operations/rescore_participant_responses.py RESPONSE_ID ...
  python human_pilot/operations/rescore_participant_responses.py --qa-item-id UUID
  python human_pilot/operations/rescore_participant_responses.py --participant "test user 2"
