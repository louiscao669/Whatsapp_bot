...
Usage (from repo root):
  ...
  python human_pilot/operations/link_participant.py --whatsapp 15551234567 --telegram 987654321 \
      --display-name "Participant 03"

  # Attach a Telegram id to an existing participant
  python human_pilot/operations/link_participant.py --participant-id <uuid> --telegram 987654321

  # Preview without writing
  python human_pilot/operations/link_participant.py --whatsapp 15551234567 --telegram 987654321 --dry-run
"""
