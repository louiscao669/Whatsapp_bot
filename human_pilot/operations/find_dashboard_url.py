...
Usage (from repo root):
  python human_pilot/operations/find_dashboard_url.py                 # list recent participants
  python human_pilot/operations/find_dashboard_url.py --query louis   # filter by name/id/contact
  python human_pilot/operations/find_dashboard_url.py --provider telegram
  python human_pilot/operations/find_dashboard_url.py --base-url http://localhost:7860
"""
