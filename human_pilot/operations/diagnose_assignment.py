...
Usage (from repo root):
  python human_pilot/operations/diagnose_assignment.py --participant-id <uuid>
  python human_pilot/operations/diagnose_assignment.py --identifier 15551234567     # phone or chat id
  python human_pilot/operations/diagnose_assignment.py --identifier 987654321 --provider telegram
"""
