...
Order of operations for a re-slate:
  ...
  1. python human_pilot/reset_experiment_plan.py --dry-run          # inspect, writes nothing
  2. python human_pilot/reset_experiment_plan.py                    # plan cells + retired passages
  3. python human_pilot/pilot_import.py
  4. python human_pilot/build_experiment_plan.py --all-consented
...
def main():
    ...
    from backend.shared.config import load_configurations  # loads .env  # noqa: E402
    ...
    with factory() as db:
        ...
        print("\nnext:")
        print("  python human_pilot/pilot_import.py")
        print("  python human_pilot/build_experiment_plan.py --all-consented")
    return 0
