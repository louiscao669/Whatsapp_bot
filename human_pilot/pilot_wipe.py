...
Usage:
  python human_pilot/pilot_wipe.py                    # dry run (counts only)
  python human_pilot/pilot_wipe.py --confirm          # delete QA + experiment passages
  python human_pilot/pilot_wipe.py --confirm --include-passage-translations
"""
