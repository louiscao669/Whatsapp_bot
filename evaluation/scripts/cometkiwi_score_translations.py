...
Usage:
  python evaluation/scripts/cometkiwi_score_translations.py --chapters 1 2 3 4 5 6 7 8
  python evaluation/scripts/cometkiwi_score_translations.py --chapters 1 --scan-defects
"""
...
from evaluation.scripts.mqm_score_translations import (  # noqa: E402
    parse_verse_blocks,
    target_block_index,
)
...
def main() -> int:
    ...
    parser.add_argument(
        "--source-template", default="evaluation/datasets/test_passage_luke{chapter}.txt")
