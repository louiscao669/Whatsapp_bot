...
Usage:
  python scripts/pseudonyms/legacy_luke/apply_pseudonym_remap.py --dry-run  # from evaluation/
  python scripts/pseudonyms/legacy_luke/apply_pseudonym_remap.py            # from evaluation/
"""
...
def main():
    ...
    if not os.path.isdir(REMAP_DIR):
        sys.exit(
            ...
            f"(run evaluation/scripts/pseudonyms/legacy_luke/build_pseudonym_remap.py first)"
        )
