...
passage p2 numbers (printed side by side, read from p2_item_variance_component.csv).
  ...
  python evaluation/scripts/item_sensitivity_window3.py                    # both families, {0,15,30}
  python evaluation/scripts/item_sensitivity_window3.py --families omission --doses 0 10 20 30
  python evaluation/scripts/item_sensitivity_window3.py --no-per-item      # aggregate only
"""
