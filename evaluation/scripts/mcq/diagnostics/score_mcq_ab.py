...
Usage:
  python evaluation/scripts/mcq/diagnostics/score_mcq_ab.py --provider ollama --model qwen2.5:1.5b --k 5
  python evaluation/scripts/mcq/diagnostics/score_mcq_ab.py --provider ollama --model qwen3:1.7b       # ladder
"""
