...
scores_target_llama.pre_v2.json (once); --restore reverts.
  ...
  python evaluation/scripts/mcq/adapt_scores_to_llama.py            # apply (backs up)
  python evaluation/scripts/mcq/adapt_scores_to_llama.py --dry-run
  python evaluation/scripts/mcq/adapt_scores_to_llama.py --restore
"""
