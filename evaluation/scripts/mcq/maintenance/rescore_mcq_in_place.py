...
Usage (from repo root):
    ...
    python evaluation/scripts/mcq/maintenance/rescore_mcq_in_place.py \\
      evaluation/outputs/tier1/*/llama321b/llm_prompt_high/scores_target_llama.json

    python evaluation/scripts/mcq/maintenance/rescore_mcq_in_place.py --self-test
"""
...
from evaluation.scripts.scoring.current.score_generated_answers import summarize
