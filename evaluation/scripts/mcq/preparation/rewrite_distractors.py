...
Usage:
  ...
  python evaluation/scripts/mcq/preparation/rewrite_distractors.py \\
      --chapters 1 2 3 4 5 6 7 8 \\
      --provider openai --model gpt-5.6-terra \\
      --relevance-model gpt-5.6-sol \\
      --answer-provider ollama --answer-model qwen2.5:1.5b --k 1

  python evaluation/scripts/mcq/preparation/rewrite_distractors.py --self-test   # offline, no API
"""
...
from evaluation.scripts.mcq.legacy_luke.regen_mcq_tier01 import (  # noqa: E402
    randomized_three_verse_window,
)
