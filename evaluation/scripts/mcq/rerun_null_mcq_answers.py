...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "QA_algorithm/inputs/tier1_qa_verse_windows.json. Must match what the "
            "original run used: re-answering with a different context makes the "
            "repaired items non-comparable to the rest of their own cell."
        ),
    )
