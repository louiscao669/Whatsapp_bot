...
Usage (from repo root):
  python evaluation/scripts/analysis/current/report_tier1_family_split.py \
      --eval-root evaluation \
      --candidates evaluation/datasets/tier1_tile_candidates.json
  python evaluation/scripts/analysis/current/report_tier1_family_split.py --eval-root evaluation --csv out.csv
"""
...
def ladder_slope(series, n_per_dose=3):
    ...
    ``QA_algorithm/scripts/modeling/fit_item_sensitivity.py``, which is a partially-pooled IRT slope
