...
Usage:
  python3 evaluation/scripts/analysis/diagnostics/inspect_thinking_traces.py \
      --passage t1_judg9 --dose 30% --n 10 --q-type mcq
  python3 evaluation/scripts/analysis/diagnostics/inspect_thinking_traces.py --self-test
"""
