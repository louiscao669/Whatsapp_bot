...
Usage (from evaluation/):
    ...
    python evaluation/scripts/analysis/diagnostics/measure_transliteration_stability.py --self-test

    # offline dry run with a fake translator
    python evaluation/scripts/analysis/diagnostics/measure_transliteration_stability.py \\
...
def real_translator(
    ...
    from evaluation.scripts.scoring.current.translation_quality import translate_with_method
