...
Usage:
  python evaluation/scripts/scoring/metrics/cometkiwi_score_translations.py --chapters 1 2 3 4 5 6 7 8
  python evaluation/scripts/scoring/metrics/cometkiwi_score_translations.py --chapters 1 --scan-defects
"""
...
from evaluation.scripts.scoring.metrics.mqm_score_translations import (  # noqa: E402
    parse_verse_blocks,
    target_block_index,
)
