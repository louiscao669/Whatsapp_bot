...
Usage:
  python3 evaluation/scripts/variants/maintenance/patch_protect_names.py            # apply
  python3 evaluation/scripts/variants/maintenance/patch_protect_names.py --check    # dry run
"""
...
TARGET = Path("evaluation/scripts/variants/current/create_grammar_variants.py")
