...
Usage:
  python evaluation/scripts/score_mcq_ab.py --provider ollama --model qwen2.5:1.5b --k 5
  python evaluation/scripts/score_mcq_ab.py --provider ollama --model qwen3:1.7b       # ladder
"""
...
def parse_args():
    ...
    ap.add_argument("--testset", default="evaluation/mcq_ab_testset.json")
