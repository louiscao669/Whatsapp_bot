...
#   2. runs evaluation/scripts/scoring/legacy_luke/answer_score_subset_in_place.py to answer all
...
#
# USAGE:
#   bash evaluation/scripts/campaigns/legacy_luke/run_variants_multimodel.sh              # both models, all defects
#   MODELS="1.5b" bash evaluation/scripts/campaigns/legacy_luke/run_variants_multimodel.sh
#   DEFECTS="untranslated local_inconsistency" bash evaluation/scripts/campaigns/legacy_luke/run_variants_multimodel.sh
