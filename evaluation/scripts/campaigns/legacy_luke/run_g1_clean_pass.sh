...
#
# Usage:
#   bash evaluation/scripts/campaigns/legacy_luke/run_g1_clean_pass.sh
#   CHAPTERS="1 2 3" bash evaluation/scripts/campaigns/legacy_luke/run_g1_clean_pass.sh
#   DRY_RUN=1 bash evaluation/scripts/campaigns/legacy_luke/run_g1_clean_pass.sh
