...
Usage (from repo root):
    ...
    python evaluation/scripts/campaigns/maintenance/seed_defect_zero_from_clean.py          # report
    python evaluation/scripts/campaigns/maintenance/seed_defect_zero_from_clean.py --write
"""
