#!/usr/bin/env python3
"""Offline tests for evaluation/scripts/analysis/current/run_tier1_dimension_study.py."""
...
sys.path.insert(0, str(REPO_ROOT / "evaluation" / "scripts" / "analysis" / "current"))

import run_tier1_dimension_study as study  # noqa: E402
