...
from eten_shared.models import Participant, ParticipantEvent, Reminder, ReminderStatus, SessionState, utc_now
...
def process_batch_next_assignment_reminder(db: Session, reminder: Reminder):
    ...
    """
    from app.services.workflow import create_assignment_prompt
