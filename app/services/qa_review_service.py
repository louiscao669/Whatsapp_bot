...
from app.models import QAItem, utc_now
from app.services.audio_export_service import chapter_label_from_reference
...
def qa_item_is_recordable(qa_item: QAItem) -> bool:
    """Eligible for /admin/record after QA text review."""
