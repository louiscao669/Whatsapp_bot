...
`http://localhost:7860/admin/qa-items` → click **Luke 1:2**

Set Chinese keywords on `http://localhost:7860/admin/record?language=chinese`.

## Admin UI: add / remove QA items

On `/admin/qa-items` (admin login required):
