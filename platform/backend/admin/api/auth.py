...
from backend.admin.nav import SPA_NAV_EXPORTS, SPA_NAV_PAGES, nav_pages_for_role
...
from backend.shared.admin_session import (
    clear_admin_session,
...
def _serialize_user(user):
    from backend.shared.admin_session import normalize_role
