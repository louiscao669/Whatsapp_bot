...
from backend.shared.media import (
...
from backend.user_dashboard.payload import get_user_dashboard_payload
from backend.user_dashboard.rewards import claim_batch_chest_reward
from backend.user_dashboard.community import (
...
from backend.user_dashboard.profile import load_profile_photo, update_profile_photo
from backend.user_dashboard.engagement import (
    mark_dashboard_question_viewed,
    record_dashboard_heartbeat,
)
from backend.user_dashboard.store import (
    purchase_store_item,
    set_cosmetic_equipped,
)
from backend.user_dashboard.settings import (
    set_user_streak_pause,
    update_dashboard_settings,
)
from backend.user_dashboard.questions import (
...
USER_DASHBOARD_DIR = REPO_ROOT / "platform" / "frontends" / "user_dashboard"
