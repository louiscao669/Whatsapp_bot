...
The browser assets live in this directory. The Flask routes, feature services,
and view-model composition live together under `platform/backend/user_dashboard/`.
...
```bash
python platform/frontends/user_dashboard/server.py
```
