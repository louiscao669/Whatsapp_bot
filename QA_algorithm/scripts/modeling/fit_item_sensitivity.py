...
Run
  python3 QA_algorithm/scripts/modeling/fit_item_sensitivity.py                      # real fit, defaults
  python3 QA_algorithm/scripts/modeling/fit_item_sensitivity.py --self-test          # synthetic recovery check
  python3 QA_algorithm/scripts/modeling/fit_item_sensitivity.py --difficulty anchor  # force 1-var everywhere
"""
