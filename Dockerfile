...
WORKDIR /build
COPY platform/frontends/admin/package.json platform/frontends/admin/package-lock.json* ./
RUN npm install
COPY platform/frontends/admin ./
RUN npm run build
...
COPY --from=frontend /build/dist /code/platform/frontends/admin/dist
